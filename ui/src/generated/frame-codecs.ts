...
export const scanLibraryCodec = createSchemaPostcardCodec(1, {"title":"ScanLibraryInput","type":"object"} as ComplexSchema, {"title":"Array_of_WallPackage","type":"array","items":{"$ref":"#/definitions/WallPackage"}} as ComplexSchema, {"WallPackage":{"type":"object","required":["gravity","id","packageType","path","title"],"properties":{"id":{"type":"string"},"title":{"type":"string"},"path":{"type":"string"},"previewPath":{"type":["string","null"]},"packageType":{"type":"string"},"gravity":{"type":"string"}}}} as Record<string, ComplexSchema>, true)! as FrameCodec<ScanLibraryInput, Array_of_WallPackage>;
